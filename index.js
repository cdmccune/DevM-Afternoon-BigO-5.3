...
// ANSWER: No, constant time complexity is the best you can get. Here they will always only ever do a defined number of operations bc it will hit 4
...
// ANSWER: No, they are both O(n) but the second one doesn't create temporary variables like the first so it is lower


// Q: What is the space complexity of each? 
// ANSWER - countLetters:
// ANSWER - countLettersRoundTwo: better


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER: First one has a string, object and array while the second just has an object and a string
